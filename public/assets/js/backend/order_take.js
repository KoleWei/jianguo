define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'order_take/index' + location.search,
                    add_url: 'order_take/add',
                    edit_url: 'order_take/edit',
                    del_url: 'order_take/del',
                    multi_url: 'order_take/multi',
                    table: 'order_take',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'order.orderno', title: __('Order.orderno')},
